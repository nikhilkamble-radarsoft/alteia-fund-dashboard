      ...
      <div className="bg-white rounded-lg overflow-hidden">
        <ResponsiveContainer width="100%" height={height}>
          <AreaChart data={data} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
            ...
            <XAxis dataKey={xDataKey} axisLine={false} tickLine={false} tick={{ fill: "#9CA3AF", fontSize: 13 }} />
            <YAxis hide={true} />
            <Tooltip content={<CustomTooltip />} cursor={{ stroke: gradientColor, strokeWidth: 1, strokeDasharray: "3 3" }} />
            <Area
              type="monotone"
              dataKey={yDataKey}
              stroke={lineColor}
